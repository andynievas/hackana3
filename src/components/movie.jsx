...
export default function Movie({ movie }){
    ...
    return <div className="movie-card h-100" >
        ...
        <Link to="/movie" className="text-light text-decoration-none" >
            <div className="visible-area h-100" >
                <img className="w-100 h-100 rounded my-shadow" src={ imgURL } alt={movie.title} onLoad={ ()=> setLoading( false ) } />
        ...
        <div className="info h-100" >
            <div className="imgFondo rounded my-auto" style={{ backgroundImage: `url(${ imgURL })` }} >
                <div className="blur " >
